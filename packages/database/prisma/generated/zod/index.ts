...
export const AccountScalarFieldEnumSchema = z.enum(['access_token','expires_at','id','id_token','oauth_token','oauth_token_secret','provider','providerAccountId','refresh_token','refresh_token_expires_in','scope','session_state','token_type','userId']);

export const RelationLoadStrategySchema = z.enum(['query','join']);

export const SessionScalarFieldEnumSchema = z.enum(['createdAt','expires','id','sessionToken','userId']);

export const UserScalarFieldEnumSchema = z.enum(['id','createdAt','firstName','lastName','email','emailVerified','image','name','updatedAt']);
